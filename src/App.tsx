...
function App() {
  const [markdown, setMarkdown] =
    useState<string>(`<h1>Garlic bread with cheese: What the science tells us</h1>
  <p>
  ...
  return (
    <>
      ...
      <div>
        ...
        <button className="btn-primary btn">One</button>
        <button className="btn-secondary btn">Two</button>
        <button className="btn-outline btn-accent btn">Three</button>
      </div>
